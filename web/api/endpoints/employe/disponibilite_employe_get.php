...
if (!$date || !$codeEmploye || !$heureActuelle) {
    http_response_code(400);
    error_log("Paramètres manquants. Date: $date, Code Employe: $codeEmploye, Heure: $heureActuelle");
...
try {
    ...
    $stmt = $pdo->prepare("
        ...
        AND JOUR = :date
        AND (STATUT = 'DISPONIBLE' OR (STATUT = 'INDISPONIBLE' AND HEURE = :heureActuelle))
        ORDER BY HEURE
    ");
