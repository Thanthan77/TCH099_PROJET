...
INSERT INTO Employe (
  ...
  COURRIEL, TELEPHONE, ADRESSE, DATE_NAISSANCE, POSTE
) VALUES
  (100, 'Alice',    'Durand',   'Celibataire', 'Au8$kLm3Tq',  'alice.durand@example.com',   5141234567, '123 rue des Lilas',         '1985-03-22', 'Médecin'),
  (101, 'Jean',     'Dupont',   'Marier',      'jD4#Rt9YpV',  'jean.dupont@example.com',    5141234568, '456 rue des Érables',       '1978-11-10', 'Médecin'),
  (102, 'Monique',  'Jodoin',   'Celibataire', 'Mr5!Nq2KbZ',  'monique.jodoin@example.com', 5141234569, '789 rue des Pins',          '1990-06-15', 'Médecin'),
  (200, 'Bruno',    'Martin',   'Marier',      'Bx7%Re1JmP',  'bruno.martin@example.com',   5141234570, '321 rue Ontario',           '1982-02-05', 'Infirmier'),
  (201, 'Isabelle', 'Langlois', 'Celibataire', 'Iu3&Ka8LdY',  'isabelle.langlois@example.com',5141234571, '654 rue Mont-Royal',     '1992-09-18', 'Infirmier'),
  (202, 'Dominic',  'Dublois',  'Celibataire', 'Dp6@Vz4XcQ',  'dominic.dublois@example.com',5141234572, '987 rue Sherbrooke',        '1988-12-03', 'Infirmier'),
  (300, 'Claire',   'Moreau',   'Marier',      'Cn9#Hj2MfW',  'claire.moreau@example.com',  5141234573, '135 rue Papineau',          '1980-07-25', 'Secrétaire'),
  (301, 'Xavier',   'Dubé',     'Celibataire', 'Xb5$Qn3RpK',  'xavier.dube@example.com',    5141234574, '246 rue Sainte-Catherine',  '1995-04-12', 'Secrétaire'),
  (400, 'George',   'Smith',    'Marier',      'Gt8!Lz1WfR',  'george.smith@example.com',   5141234575, '369 rue Berri',             '1975-01-30', 'Administrateur');
