...
CREATE TABLE Exception_horaire (
  ...
  HEURE_DEBUT    TIME               NOT NULL,
  HEURE_FIN      TIME               NOT NULL,
  TYPE_EXCEPTION ENUM('VACANCES','RÉUNION','INDISPONIBLE', 'ATTENTE') NOT NULL,
...
INSERT INTO Exception_horaire (CODE_EMPLOYE, DATE_EXCEPTION, HEURE_DEBUT, HEURE_FIN, TYPE_EXCEPTION) VALUES
  (100, '2025-08-15', '08:00:00', '16:00:00', 'VACANCES'),
  (101, '2025-07-28', '10:00:00', '12:00:00', 'RÉUNION'),
  (102, '2025-08-01', '09:00:00', '12:00:00', 'INDISPONIBLE'),
  (200, '2025-07-29', '11:00:00', '12:30:00', 'RÉUNION'),
  (201, '2025-08-05', '13:00:00', '17:00:00', 'ATTENTE'),
  (202, '2025-08-10', '09:00:00', '13:00:00', 'VACANCES');
